<?php
// Test API with user role (not staff)
error_reporting(E_ALL);
ini_set('display_errors', 1);

// Simulate API environment with USER role
session_start();
$_SESSION['user_id'] = 1;
...
try {
    ...
    if ($user_role != 'admin' && $user_role != 'staff') {
        ...
        echo "<p>Added user_id filter for non-admin/non-staff</p>";
    }
    ...
    if (!empty($results)) {
        ...
        echo "<tr style='background-color: #f2f2f2;'><th>ID</th><th>Title</th><th>User ID</th><th>Username</th></tr>";
    ...
    echo "<p style='color: green;'>API user role test successful!</p>";
