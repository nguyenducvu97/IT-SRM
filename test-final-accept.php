<?php
echo "=== FINAL TEST ACCEPT REQUEST ===" . PHP_EOL;
...
$pdo->exec("INSERT INTO service_requests (user_id, title, description, category_id, priority, status, created_at) VALUES (4, 'Final Test Request', 'Final test for accept request', 1, 'medium', 'open', NOW())");
$request_id = $pdo->lastInsertId();
echo "Created test request #$request_id" . PHP_EOL;

// Test GET accept_request (like frontend does)
...
// Set REQUEST_METHOD before including the file
$_SERVER['REQUEST_METHOD'] = 'GET';

// Debug: Check what method is set
echo "DEBUG: REQUEST_METHOD = " . $_SERVER['REQUEST_METHOD'] . PHP_EOL;
echo "DEBUG: GET action = " . $_GET['action'] . PHP_EOL;
echo "DEBUG: GET request_id = " . $_GET['request_id'] . PHP_EOL;
