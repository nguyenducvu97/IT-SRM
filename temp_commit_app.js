...
class ITServiceApp {
    ...
    displayPagination(data) {
        ...
        // Always show pagination, but disable next/prev when only 1 page
        const isSinglePage = total_pages <= 1;
...
// DISABLED: Use NotificationManager singleton instead



console.log('updateNotificationCount called but disabled to prevent conflict with NotificationManager');
...
ITServiceApp.prototype.toggleNotificationDropdown = async function() {
    ...
    if (dropdown.style.display === 'block') {
        ...
        // Load notifications before showing dropdown - DISABLED to prevent conflict with NotificationManager
...
// Display notifications in dropdown - DISABLED to prevent conflict with NotificationManager

ITServiceApp.prototype.displayNotificationsInDropdown = function(notifications) {

    // DISABLED: Use NotificationManager singleton instead

    console.log('displayNotificationsInDropdown called but disabled to prevent conflict with NotificationManager');
