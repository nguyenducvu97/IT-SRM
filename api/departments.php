...
// Allow public access for dropdown action (used in registration form)
if ($action === 'dropdown') {
    // Public access allowed for dropdown
} else {
    // Check if user is authenticated and is admin for other actions
    startSession();
