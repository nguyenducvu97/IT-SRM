<?php
echo "=== TEST PUT ACCEPT REQUEST ===" . PHP_EOL;
...
$pdo->exec("INSERT INTO service_requests (user_id, title, description, category_id, priority, status, created_at) VALUES (4, 'PUT Test Request', 'Test request for PUT method', 1, 'medium', 'open', NOW())");
$request_id = $pdo->lastInsertId();
echo "Created test request #$request_id" . PHP_EOL;

// Test PUT accept_request
...
echo "Testing PUT accept_request for request #$request_id" . PHP_EOL;
