...
echo "<h2>Test Create Multipart</h2>";
...
$_POST['action'] = 'create';
$_POST['title'] = 'Multipart Test Request ' . date('H:i:s');
$_POST['description'] = 'Multipart test description';
$_POST['category_id'] = '1';
...
echo "<p>Checking multipart detection...</p>";
if (strpos($_SERVER['CONTENT_TYPE'], 'multipart/form-data') !== false) {
    echo "<p style='color: green;'>Multipart detected correctly</p>";
} else {
    echo "<p style='color: red;'>Multipart not detected</p>";
}
...
try {
    ...
    $query = "SELECT id, title, created_at FROM service_requests 
             WHERE user_id = :user_id AND title LIKE '%Multipart Test Request%'
